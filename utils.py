...
def setup_model(cfg):
    ...
    if cfg.use_drv and cfg.use_rt:
        cfg.save_dir = f"/data/irfan/MUSE-News/{cfg.forget_loss}_DRV_{cfg.derivative_loss}_RT_{cfg.retain_loss}_{cfg.lr}"
    elif cfg.use_drv:
        cfg.save_dir = f"/data/irfan/MUSE-News/{cfg.forget_loss}_DRV_{cfg.derivative_loss}_{cfg.lr}"
    elif cfg.use_rt:
        cfg.save_dir = f"/data/irfan/MUSE-News/{cfg.forget_loss}_RT_{cfg.retain_loss}_{cfg.lr}"
    else:
        cfg.save_dir = f"/data/irfan/MUSE-News/{cfg.forget_loss}_{cfg.lr}"
